...
tanggallengkap = namahari[hari] + ", " +tanggal + " " + namabulan[bulan] + " " + tahun;
    ...
    <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
      ...
      <body class="skin-black">
		...
		<b>E-Lib4Shared(Membaca Mudah Berbagi Berkah!)Edisi Ramadhan, Untuk Login Admin silahkan klik Icon User atau klik <a href="login.html">disini</a></b>
          </div>
            </div>
                    ...
                    <div class="twt-area">
                        <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-pengunjung.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <textarea rows="4" name="saran" id="saran" class="form-control" placeholder="Saran Anda untuk E-Lib4Shared" cols="25"></textarea>
                                  <!--<span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span>-->
                              </div>
                          </div>
                          <div class="form-group">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">E-Lib4Shared Info</h4>
      </div>
      <div class="modal-body">
      E-Lib4Shared adalah aplikasi perpustakaan bebasis website yang responsif, namun masih dari kata sempurna dalam hal desain interface dan service maka dari itu
	  anda dapat mengkritik langsung untuk turut membantu membangun E-Lib4Shared menjadi lebih baik. Hubungi Febby Ronaldo di :
      <table>
      <tr>
      <td>No Telepon</td> <td>:</td> <td>0857 303 234 30</td>
      </tr>
      <br />
      <tr>
      <td>E-mail</td><td>:</td> <td><a href="mailto:fourteenfero@gmail.com">fourteenfero@gmail.com</a></td>
      </tr> 
      <br />
      <tr>
      <td>Blog</td>       <td>:</td> <td><a href="#" target="_blank">www.fero4ummat.com</a></td>
      </tr>
      <br />
      <tr>
      <td>Website</td>    <td>:</td> <td><a href="#" target="_blank">www.feroweb.com</a></td>
      </tr>
       </table>
      </div>
