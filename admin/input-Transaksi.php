                    ...
                    <div class="row">
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-Transaksi.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                  ...
                                  <option> -- Pilih Salah Satu --</option>
									<?php
										$query = "SELECT * FROM data_buku ORDER by id";
                                  ...
                                  <option> -- Pilih Salah Satu --</option>
									<?php 
										...
										while ($nama=mysql_fetch_array($sql)) {
											echo "<option value='$nama[0].$nama[1]'>$nama[2]. $nama[1]</option>";
										}
									?>
                                  </select>
                              </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input name="tgl_pinjam" type="text" class="form-control" id="tgl_pinjam" value="<?php echo $pinjam; ?>" readonly="readonly"/>
                              </div>
                          </div>
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tanggal Kembali</label>
                              <div class="col-sm-10">
                                  <input name="tgl_kembali" type="text" class="form-control" id="tgl_kembali" value="<?php echo $kembali; ?>" readonly="readonly"/>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Keterangan</label>
                              <div class="col-sm-8">
                                  <input name="ket" type="text" id="ket" class="form-control" placeholder="Keterangan" required />
                              </div>
                          </div>						  
