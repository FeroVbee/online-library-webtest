                    ...
                    <div class="row">
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-buku.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="th_terbit" type="text" id="th_terbit" class="form-control" placeholder="Ex : 2017" required />
							  </div>
                          </div>
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Penerbit</label>
                              <div class="col-sm-8">
                                  <input name="penerbit" type="text" id="penerbit" class="form-control" placeholder="Nama Penerbit" required />
                              </div>
                          </div>
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">ISBN</label>
                              <div class="col-sm-8">
                                  <input name="isbn" type="text" id="isbn" class="form-control" placeholder="Angka Standar Buku Internasional" required />
                              </div>
                          </div>
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Kategori</label>
                              <div class="col-sm-8">
                                  <input name="kategori" type="text" id="kategori" class="form-control" placeholder="Kategori Buku" required />
                              </div>
                          </div>							  
						  <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
								  ...
								  <option value="RAK H1">RAK H1</option>
                                  <option value="RAK H2">RAK H2</option>
								  <option value="RAK T1">RAK T1</option>
                                  <option value="RAK T2">RAK T2</option>
                                  </select>
                              </div>
                          </div>
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                  ...
                                  <option value="Pemberian Siswa">Pemberian Siswa</option>
                                  </select>
                              </div>
                          </div>						  
						  <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input name="tgl_input" type="text" class="form-control" id="tgl_input" value="<?php echo "".date("Y/m/d - H:i:s").""; ?>" readonly="readonly"/>
                              </div>
                          </div>
